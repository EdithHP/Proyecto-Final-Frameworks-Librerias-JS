...
function fillBoard() {
	...
	column.each(function () {
		...
		for (var i = 0; i < agrega; i++) {
			...
			if (i === 0 && candys < 1) {
				$(this).append('<img src="image/' + candyType + '.png" class="element" style="width:90%;"></img>');
			} else {
				$(this).find('img:eq(0)').before('<img src="image/' + candyType + '.png" class="element" style="width:90%;"></img>');
			}
		}
	});
	addCandyEvents();
